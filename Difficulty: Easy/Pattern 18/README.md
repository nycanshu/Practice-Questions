<h2><a href="https://www.geeksforgeeks.org/problems/triangle-pattern-1662286302/1?page=1&status=attempted&sortBy=submissions">Pattern 18</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Ram is very fond of patterns. Once, his teacher gave him a pattern to solve. He gave Ram an integer <strong>n </strong>and asked him to build a pattern.</span></p>
