...
class Intersect {
    ...
    int intersectPoint(Node head1, Node head2) {
        ...
        // Traverse both lists
        while (ptr1 != ptr2) {
            // When ptr1 reaches the end of list1, reset to head of list2
            ptr1 = (ptr1 == null) ? head2 : ptr1.next;
            // When ptr2 reaches the end of list2, reset to head of list1
            ptr2 = (ptr2 == null) ? head1 : ptr2.next;
        }
        
        // If there's an intersection, ptr1 (or ptr2) will be at the intersection node
        // Otherwise, they will both be null at the end
