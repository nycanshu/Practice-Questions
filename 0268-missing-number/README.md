<h2><a href="https://leetcode.com/problems/missing-number/?envType=problem-list-v2&envId=hash-table">268. Missing Number</a></h2><h3>Easy</h3><hr><p>Given an array <code>nums</code> containing <code>n</code> distinct numbers in the range <code>[0, n]</code>, return <em>the only number in the range that is missing from the array.</em></p>
